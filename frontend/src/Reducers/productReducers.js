...
export const productListSuggestionsReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        case PRODUCT_LIST_SUGGESTIONS_REQUEST:
            return {
                loading: true,
                products: []
            }
        case PRODUCT_LIST_SUGGESTIONS_SUCCESS:
            return {
                loading: false,
                products: action.payload
            }
        case PRODUCT_LIST_SUGGESTIONS_FAIL:
            return {
                loading: false,
                error: action.payload
            }
