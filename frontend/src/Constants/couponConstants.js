...
export const COUPON_LIST_MY_REQUEST = 'COUPON_LIST_MY_REQUEST'
export const COUPON_LIST_MY_SUCCESS = 'COUPON_LIST_MY_SUCCESS'
export const COUPON_LIST_MY_FAIL = 'COUPON_LIST_MY_FAIL'